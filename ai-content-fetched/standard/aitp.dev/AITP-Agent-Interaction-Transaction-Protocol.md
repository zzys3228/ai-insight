...
**Note:** "Transaction" in technical protocol context is typically translated as **事务** (shìwù) rather than 交易 (jiāoyì), as it refers to data/operation transactions rather than commercial transactions.

If referring specifically to AI agents, it could also be:
**AITP：智能体交互与事务协议**
source: aitp.dev
url: https://aitp.dev
date: 2026-06-22
...
translated: true
fetched_at: 2026-06-22T20:18:33.428762
---
# # Translation
