...
探索Android Studio新功能，介绍Agent模式、Gemini Enterprise/Google One支持、Android Bench基准测试、本地模型推荐（Gemma 4），展示如何同时为开发者与AI智能体服务。
...
**核心要点：Android Studio Otter关键更新、Android Bench基准测试、Gemini Enterprise/Google One支持、本地模型推荐**

---

*原文请访问 [Google I/O](https://www.youtube.com/watch?v=N4GgGBKnHe4)*
