...
> **状态**：✅ 已更新（2026-06-22）按维度重构·产品URL规则优化
...
| 优先级 | URL类型 | 示例 | 说明 |
|--------|---------|------|------|
| ✅首选 | Release Notes/Changelog | openai.com/blog, anthropic.com/news | **产品更新日志** |
| ✅首选 | 官方博客 | blogs.nvidia.com | 官方博客 |
| ✅可选 | API文档 | platform.openai.com/docs | 开发者文档 |
| ✅可选 | 年度大会 | io.google | 大会主页 |
| ❌避免 | 公司首页 | nvidia.com | 应指向具体产品 |
| ❌避免 | 产品介绍页 | nvidia.com/product | 缺少更新历史 |

### 产品URL必须包含更新历史

**❌ 错误**：只放产品介绍页
**✅ 正确**：产品介绍页 + Release Notes/Changelog
...
{公司}/{产品}/changelog
{公司}/{产品}/releases
learn.microsoft.com/{产品}/release-notes
